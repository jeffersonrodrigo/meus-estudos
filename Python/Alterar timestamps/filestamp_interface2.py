...
def alterar_filestamp(pasta_selecionada):
    ...
    if alterados_com_sucesso > 0:
        ...
        messagebox.showerror("Erro", f"Não foi possível alterar o filestamp dos seguintes arquivos:\n{', '.join(erros)}")
    else:
        messagebox.showwarning("Aviso", "Não foi possível alterar o filestamp de nenhum arquivo.")
